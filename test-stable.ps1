...
$payload = @{
    ...
    changelog    = "- Fixed various structure generation issues`n- Improved loot table balance`n- Added new room variant to mega fortress"
    imageUrls    = @()
    dryRun       = $true
...
Write-Host "Stable dry-run posted! releaseId: $($response.releaseId)"
